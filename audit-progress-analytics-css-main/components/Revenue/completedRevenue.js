...
const CompletedRevenue = () => {
  ...
  function getJobAnalytics() {
    getAnalytics()
      .then((res) => {
        ...
        let completedRevenue = completedJobArr.reduce((accumulator, data) => {
          return accumulator + data.revenue;
        }, 0);
        setCompletedRevenue(completedRevenue);

        //group and non group data same as ROI.js part c2, c3
  ...
  useEffect(() => {
    console.log(
      "🚀 ~ file: completedRevenue.js ~ line 408 ~ useEffect ~ chosen",
      chosen
    );
    let dataArr = [];
    ...
    axisArr.reverse();
    console.log(
      "🚀 ~ file: completedRevenue.js ~ line 418 ~ useEffect ~ axisArr",
      axisArr
    );
  ...
  return (
    <>
      <div className={styles.pieCharts}>
        <h3 className={styles.title}>Revenue of Completed Jobs</h3>
